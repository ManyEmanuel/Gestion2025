  ...
  >
    <q-card style="width: 800px; max-width: 80vw">
      <q-card-section class="row">
        <div class="text-h6">Transferencia secundaria</div>
        <q-space />
        <q-btn
          icon="close"
      ...
      <q-card-section>
        <q-form class="row q-col-gutter-xs">
          ...
          <div class="col-12 col-xs-12 col-md-6">
            <q-input v-model="encabezado.aprobo" label="Aprobó" readonly />
          </div>
...
const { modal_ver, encabezado } = storeToRefs(transferenciaStore);
const actualizarModal = () => {
  transferenciaStore.actualizarModalVer(false);
};
</script>
